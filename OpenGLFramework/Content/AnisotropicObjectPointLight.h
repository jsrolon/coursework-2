/**********************************************************************
NAME: AnisotropicObjectPointLight.h
...
#ifndef _ANISOTROPIC_OBJECT_POINTLIGHT
#define _ANISOTROPIC_OBJECT_POINTLIGHT
...
class AnisotropicObjectPointLight: public OpenGLContent{
	//Config parameters
...
public:
	AnisotropicObjectPointLight( std::string model,std::string texture, glm::vec3 lightPos = glm::vec3(4,4,4))
