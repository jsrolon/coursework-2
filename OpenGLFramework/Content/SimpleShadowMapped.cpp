...
bool SimpleShadowMapped::loadResourcesToMainMemory(){
...
bool SimpleShadowMapped::allocateOpenGLResources(){
	...
	programID = LoadShaders( "OpenGLFramework/shaders/ShadowMap.vertexshader", "OpenGLFramework/shaders/ShadowMap.fragmentshader" );
...
bool SimpleShadowMapped::render(glm::mat4 P, glm::mat4 V){
	// Use our shader
...
bool SimpleShadowMapped::unallocateAllResources(){
